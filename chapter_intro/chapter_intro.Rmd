...
1. There will be ***three quizzes*** on Moodle $\rightarrow$ 30%

--

1. There will be ***two take home exams / case studies*** $\rightarrow$ 70%
...
We will ***exclusively*** use Moodle Discussion Forum for our interactions.

Please ***DO NOT*** contact me by email (unless there's a legitimate reason to).

I will be checking Moodle sparingly so please help one another!
]
